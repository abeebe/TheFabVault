    ...
    <div className="min-h-screen bg-surface flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">MakerVault</h1>
...
export function App() {
  ...
  const assetParams = {
    ...
    folder_id: selectedFolderId ?? (selectedFolderId === null && selectedTags.length === 0 && !searchQuery ? undefined : 'none'),
  };
  ...
  return (
    <div className="flex h-screen bg-surface overflow-hidden">
      <Sidebar
        ...
        onFolderSelect={(id) => { setSelectedFolderId(id); setSelectedTags([]); }}
